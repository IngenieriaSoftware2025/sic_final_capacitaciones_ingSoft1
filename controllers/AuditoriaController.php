...
class AuditoriaController extends ActiveRecord{
    ...
    public static function registrarActividad($accion, $descripcion) {
        try {
            ...
            $sql_ruta = "SELECT ruta_id FROM kvsc_rutas WHERE ruta_nombre = ? AND ruta_situacion = 1";
            $ruta_existe = self::fetchFirst($sql_ruta, [$accion]);
            ...
            if (!$ruta_existe) {
                ...
                $ruta_nueva = self::fetchFirst($sql_ruta, [$accion]);
            ...
            return self::SQL($sql, [$usuario_id, $ruta_id, $descripcion]);
