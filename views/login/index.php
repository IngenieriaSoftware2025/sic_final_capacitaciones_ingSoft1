<div class="row justify-content-center">
    <form class="col-lg-4 border rounded shadow p-4 bg-light" id="FormLogin">
        ...
        <div class="row mb-3">
            <div class="col">
                <label for="usu_codigo" class="form-label">Ingrese su DPI</label>
                <input type="number" name="usu_codigo" id="usu_codigo" class="form-control" placeholder="Ingresa tu DPI" required>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col">
